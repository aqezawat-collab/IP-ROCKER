#!/usr/bin/env bash
#
# Auto installer/updater for IP-ROCKER
#
# Usage:
#   curl -fsSL https://github.com/aqezawat-collab/IP-ROCKER/raw/refs/heads/main/install.sh | bash
#   
#
# Pre-release support:
#   curl -fsSL https://github.com/aqezawat-collab/IP-ROCKER/raw/refs/heads/main/install.sh | bash -s -- --prerelease
#   or
...
REPO="aqezawat-collab/IP-ROCKER"
BIN_NAME="iprocker"
